...
import com.ssafy.nopo.api.service.UserDetailsServiceImpl;
import com.ssafy.nopo.common.auth.jwt.AuthEntryPointJwt;
import com.ssafy.nopo.common.auth.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] Exclude_Paths =
            {"/api", "/api/oauth/login/**", "/api/user/join", "/api/user/duplicate-email/*", "/api/user/duplicate-nickname/*",
